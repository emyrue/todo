...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ makeNew)\n/* harmony export */ });\n/* harmony import */ var _listItem_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./listItem.js */ \"./src/listItem.js\");\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n\n\n\n\nfunction makeNew(newListItem, toDo) {\n  newListItem.addEventListener('keypress', (e) => {\n    if ((e.key === 'Enter') && (newListItem.value)) {\n      const toDoItem = new _listItem_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](newListItem.value, false, toDo.list.length);\n      toDo.add(toDoItem);\n      toDo.store();\n    }\n  });\n\n  _index_js__WEBPACK_IMPORTED_MODULE_1__.enter.addEventListener('click', () => {\n    if (newListItem.value) {\n      const toDoItem = new _listItem_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](newListItem.value, false, toDo.list.length);\n      toDo.add(toDoItem);\n      toDo.store();\n      (0,_index_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(_index_js__WEBPACK_IMPORTED_MODULE_1__.toDoList, toDo);\n      newListItem.value = '';\n    }\n  });\n}\n\n//# sourceURL=webpack://todo/./src/add.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ editItems)\n/* harmony export */ });\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n/* harmony import */ var _delete_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./delete.svg */ \"./src/delete.svg\");\n\n\n\n\nconst trash = new Image();\ntrash.src = _delete_svg__WEBPACK_IMPORTED_MODULE_1__;\nfunction editItems(toDo) {\n  for (let i = 0; i < _index_js__WEBPACK_IMPORTED_MODULE_0__.editButtons.length; i += 1) {\n    _index_js__WEBPACK_IMPORTED_MODULE_0__.editButtons[i].addEventListener('click', () => {\n      _index_js__WEBPACK_IMPORTED_MODULE_0__.editButtons[i].parentElement.classList.add('color');\n      _index_js__WEBPACK_IMPORTED_MODULE_0__.editButtons[i].parentElement.innerHTML = `\n        <input type=\"checkbox\">\n        <input class=\"edit\" type=\"text\" value=\"${toDo.list[i].description}\">\n        <img class=\"trash\" src=${_delete_svg__WEBPACK_IMPORTED_MODULE_1__}>\n      `;\n\n      const input = document.querySelector('.edit');\n      input.addEventListener('keypress', (e) => {\n        if (e.key === 'Enter') {\n          toDo.list[i].description = input.value;\n          toDo.store();\n          (0,_index_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(toDo);\n        }\n      });\n    });\n  }\n}\n\n//# sourceURL=webpack://todo/./src/edit.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ ListItem)\n/* harmony export */ });\nclass ListItem {\n  constructor(description, completed, index) {\n    this.description = description;\n    this.completed = completed;\n    this.index = index;\n  }\n\n  upOne() {\n    this.index += 1;\n  }\n\n  downOne() {\n    this.index -= 1;\n  }\n\n  complete() {\n    this.completed = true;\n  }\n\n  incomplete() {\n    this.completed = false;\n  }\n\n  edit(task) {\n    this.description = task;\n  }\n}\n\n//# sourceURL=webpack://todo/./src/listItem.js?");
